...
Revision ID: 5e330fc4df29
Revises: ecada38f6805
Create Date: 2025-03-22 03:32:50.867139
...
revision: str = '5e330fc4df29'
down_revision: Union[str, None] = 'ecada38f6805'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_Dim_Purchances_purchance_id', table_name='Dim_Purchances')
    op.drop_table('Dim_Purchances')
    op.drop_index('ix_Fact_Warranties_claim_key', table_name='Fact_Warranties')
    op.drop_table('Fact_Warranties')
    op.drop_index('ix_Dim_Locations_location_id', table_name='Dim_Locations')
    op.drop_table('Dim_Locations')
    op.drop_index('ix_Dim_Parts_part_id', table_name='Dim_Parts')
    op.drop_table('Dim_Parts')
    op.drop_index('ix_Dim_Vehicle_vehicle_id', table_name='Dim_Vehicle')
    op.drop_table('Dim_Vehicle')
    op.drop_index('ix_Dim_Supplier_supplier_id', table_name='Dim_Supplier')
...
def downgrade() -> None:
    ...
    sa.Column('part_id', sa.INTEGER(), server_default=sa.text('nextval(\'"Dim_Parts_part_id_seq"\'::regclass)'), autoincrement=True, nullable=False),
